                                        ...
                                        <div class="live__heightlight mb__30">
                                            <div class="height__table">
                                                                    ...
                                                                    <div class="t__items__left">
                                                                        <h6>
                                                                            ...
                                                                            @if(\App\Helpers\Helpers::rankTeam($fixture))
                                                                                ({{\App\Helpers\Helpers::rankTeam($fixture)->rank}} - {{str_split(\App\Helpers\Helpers::rankTeam($fixture)->form)[strlen(\App\Helpers\Helpers::rankTeam($fixture)->form) ]." - ". \App\Helpers\Helpers::rankTeam($fixture)->points}}
                                                                                )@endif
                                                                        </h6>
                                                                        <span class="text">
                                              <img height="20"  src=" {{\App\Helpers\Helpers::getTeamByID($fixture->team_away_id)['logo']}}" alt="">   {{\App\Helpers\Helpers::getTeamByID($fixture->team_away_id)['name']}}@if(\App\Helpers\Helpers::rankTeamAway($fixture))
                                                                                ({{\App\Helpers\Helpers::rankTeamAway($fixture)->rank}} - {{str_split(\App\Helpers\Helpers::rankTeamAway($fixture)->form)[strlen(\App\Helpers\Helpers::rankTeamAway($fixture)->form)] ." - ". \App\Helpers\Helpers::rankTeamAway($fixture)->points }}
                                                                                )@endif
                                            </span>
                                                                        <p>
                                                                            <a href="#0">
