        ...
        <a href="#0" class="match__fixing__items">
            ...
            <div class="match__vs">
                <div class="match__vs__left">
                    <span>
                        {{\App\Helpers\Helpers::getTeamByID($fixture->team_home_id)['name']}}

                    </span>
                    <span class="flag">
                        <img src="{{\App\Helpers\Helpers::getTeamByID($fixture->team_home_id)['logo']}}" alt="flag">
                    </span>
                </div>
                <span class="vs">
                    Vs
                ...
                <div class="match__vs__left">
                    <span class="flag">
                        <img src=" {{\App\Helpers\Helpers::getTeamByID($fixture->team_away_id)['logo']}}" alt="flag">
                    </span>
                    <span>
                        {{\App\Helpers\Helpers::getTeamByID($fixture->team_away_id)['name']}}
                    </span>
                </div>
            </div>
                            ...
                            <div class="table__wrap">
                                ...
                                <div class="table__items b__bottom">
                                    <div class="t__items">
                                        <div class="t__items__left">
                                            <h6>
                                            <img height="20" src=" {{\App\Helpers\Helpers::getTeamByID($fixture->team_home_id)['logo']}}">    {{\App\Helpers\Helpers::getTeamByID($fixture->team_home_id)['name']}}
                                            </h6>
                                            <span class="text">
                                              <img height="20" src=" {{\App\Helpers\Helpers::getTeamByID($fixture->team_away_id)['logo']}}">   {{\App\Helpers\Helpers::getTeamByID($fixture->team_away_id)['name']}}
                                            </span>
                                            <p>
                                                <a href="#0">
                                                    Live
